...
public class SumOfCoinsTests
{
    ...
    public void TestWithProvidedExample()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [50] = 18, [20] = 1, [2] = 1, [1] = 1 };
    ...
    public void TestWithOneAvailableCoin()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [1] = 42 };
    ...
    public void TestWithSeveralCoins()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [5] = 15, [2] = 1, [1] = 1 };
    ...
    public void TestWithLargeSum()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [5] = 406230824, [2] = 1, [1] = 1 };
    ...
    public void TestWithNonOptimalParameters()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [10] = 2, [1] = 7 };
    ...
    public void TestWithSmallCoins()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [4] = 308, [2] = 1 };
    ...
    public void TestWithOneCoinNeededOfEachValue()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [1000] = 1, [200] = 1, [30] = 1, [4] = 1 };
    ...
    public void TestWithOneCoinNeeded()
    {
        ...
        var expectedResult = new Dictionary<int, int> { [214] = 1 };
